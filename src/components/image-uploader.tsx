...
interface PropsWithImagePreview extends BaseProps {
  showImagePreview: true;
  imageURL: string;
}

interface PropsWithoutImagePreview extends BaseProps {
  showImagePreview?: false;
  imageURL?: never;
}

type Props = PropsWithImagePreview | PropsWithoutImagePreview;

const FileUploader: React.FC<Props> = memo(
  ({ showImagePreview = false, imageURL = "", getServerAction = () => {} }) => {
    ...
    const ImageIcon = () => {
      return <img src={imageURL} alt="Image Icon" className="w-4 h-4" />;
    };
                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="hover:bg-red-500 text-white transition-all items-center justify-center px-2 hidden group-hover:flex"
                    >
                      <X size={20} />
                    </button>
                  </div>
